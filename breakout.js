...
(function () {
                ...
                if (collidingBodies.length) {
                    ...
                    if (collidingBodies[0] instanceof Player) {
                        ...
                        if (this.player.center.x - self.ball.center.x > 15) {
                            //left side of paddle
                            self.ball.velocity.x = -12;
                            self.ball.velocity.y = -7;
                        } else if (this.player.center.x - self.ball.center.x > 3) {
                           //left-middle side of paddle
                           self.ball.velocity.x = -7;
                           self.ball.velocity.y = -12;
    ...
    var createBricks = function (game) {
        ...
        for (var i = 0; i < 24; i++) {
            ...
            bricks.push(new Brick(game, getColor2(), { x: x, y: y + 90}));
        }
    ...
    var drawRect = function (screen, body) {
        screen.fillRect(body.center.x - body.size.x / 1, body.center.y - body.size.y / 1,
